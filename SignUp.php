    ...
    <div class="modal-dialog">
        ...
        <form method="post" action="register.php" name="signup" >
            <div class="input-fld">
                ...
                <input class="main-inpt" type="text" name="usernameReg" />
            </div>
            <div class="input-fld">
                <div class="label">Email</div>
                <input class="main-inpt" type="text" name="emailReg" />
            </div>
            <div class="input-fld">
                <div class="label">Passwords</div>
                <input class="main-inpt" type="text" name="passwordReg" />
            </div>
            <div class="space-5pxno"></div>
            <div class="button-area">
                <input type="submit" class="button" name="registerSubmit" value="Signup">
                <a class="prime-btn med rt-side" href="register.php">Sign Up</a>
            </div>
