    ...
    <div class="modal-dialog">
        ...
        <form method="post" action="login.php" name="signup" >
            <div class="input-fld">
                ...
                <input class="main-inpt" type="text" name="usernameemailLog" />
            </div>
            <div class="input-fld">
                <div class="label">Password</div>
                <input class="main-inpt" type="text" name="passwordLog" />
            </div>
            <div class="space-5pxno"></div>
            <div class="button-area">
                <input type="submit" class="button" name="loginSubmit" value="Log In">
