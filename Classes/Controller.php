...
class Controller {
    ...
    public function likePhoto($photoId){
        if($this->isLoggedIn()
            ...
            $this->dbCon->voteLike($this->getThisUserId(), $photoId);
            return TRUE;
        }
        else {
            return FALSE;
    ...
    public function dislikePhoto($photoId){
        if($this->isLoggedIn()
            ...
            $this->dbCon->voteDislike($this->getThisUserId(), $photoId);
            return TRUE;
        }
        else {
            return FALSE;
    ...
    public function voteFunny($photoId){
        if($this->isLoggedIn()
            ...
            $this->dbCon->voteFunny($this->getThisUserId(), $photoId);
            return TRUE;
        }
        else {
            return FALSE;
    ...
    public function lovePhoto($photoId){
        if($this->isLoggedIn()
            ...
            $this->dbCon->voteLove($this->getThisUserId(), $photoId);
            return TRUE;
        }
        else {
            return FALSE;
